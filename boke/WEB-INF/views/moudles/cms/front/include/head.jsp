...
<link href="${ctxStatic}/layui-master/src/css/layui.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/layui-master/src/layui.js" type="text/javascript"></script>
<link href="${ctxStatic}/layui-master/src/css/modules/layer/default/layer.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/layui-master/src/lay/modules/layer.js" type="text/javascript"></script>
