...
//      majorsInput 文本框组件 
    ...
    function setDialog(index) {
        ...
        for (var j = 0; j < _data.length; j++) {
            ...
            checkboxWrap.push('<input class="majoritem" type="checkbox" ' + (flag ? "checked" : null) + ' name="' + _name + '" value="' + _data[j].value + '"/><span>' + _data[j].displayVaule + '</span>')
        }
