...
//     		parent.location = "${ctx}/login_exit.jsp";
     		parent.location = "${ctx}/admin/login_exit_pc.jsp";
    	})
    	...
    	$("#loginbtn").click(function(){
    		...
    		//parent.location = "${ctx}/logout.action";
//     		parent.location = "${ctx}/login_exit.jsp";
     		parent.location = "${ctx}/pc/login.jsp";
    	})
    	$("#homebtn").click(function(){
    		/** parent从主界面进行退出,避免局部刷新*/
    		//parent.location = "${ctx}/logout.action";
//     		parent.location = "${ctx}/login_exit.jsp";
     		parent.location = "${ctx}/pc/index.jsp";
    	})
	})
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="320" height="80" class="topbg"><img src="${ctx}/images/top_logo_qa.gif" width="320" height="80"></td>
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    
	    <tr>
		  <td height="50" class="toplink" align="right" id='useract'>
...
%>
		  ...
		  <a href="javascript:void(0);" id="homebtn">首页</a>
		  <img src="${ctx}/images/top_home.gif">&nbsp;&nbsp;
		  ...
		  <td height="30" class="topnavbg">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<img src="${ctx}/images/StatBar_admin.gif">&nbsp;&nbsp;当前用户：【${sessionScope.logined_user.name}】</td>
